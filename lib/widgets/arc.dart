...
class ArcText extends StatelessWidget {
  const ArcText({Key? key,required this.radius,required this.text,
    this.textStyle = const TextStyle(fontSize: 20, letterSpacing: 8,),//color: Colors.black
    this.startAngle = 0,}) : super(key: key);
